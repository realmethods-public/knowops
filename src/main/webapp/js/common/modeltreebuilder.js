...
function applyContainerData( the_container, typePrefix )
{
	...
	if ( the_classes !== undefined && the_classes.length > 0 )
	{
		...
		{
			content = content + applyClassData( the_classes[indx223], typePrefix + the_classes[indx223].name + "_component_", true );
		}
		content = content     + '</ul>'
							+ '</li>'
						  + '</ul>';
	...
	if ( the_classes !== undefined && the_classes.length > 0 )
	{
		...
		{
			content = content + applyServiceData( the_classes[indx22], typePrefix + the_classes[indx22].name + "_component_", true );
		}
		content = content     + '</ul>'
							+ '</li>'
						  + '</ul>';
	...
	if ( the_classes !== undefined && the_classes.length > 0 )
	{
		...
		{
			content = content + applyDtoData( the_classes[indx222], typePrefix + the_classes[indx222].name + "_component_", true );
		}
		content = content     + '</ul>'
							+ '</li>'
						  + '</ul>';
