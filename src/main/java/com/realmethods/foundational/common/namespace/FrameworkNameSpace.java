 ...
 ******************************************************************************/
package com.realmethods.foundational.common.namespace;
...
public class FrameworkNameSpace
{
    ...
    public static String getHibernateCfgFile() {
    	if ( hibernateConfigFile == null ) {
    		if ( SAAS_MODE.equalsIgnoreCase(DEPLOY_MODE) )
    			hibernateConfigFile = "hibernate.cfg.xml";
    		else
    			hibernateConfigFile = "hibernate.cfg.dev.xml";
    	}
    	    	
    	return hibernateConfigFile;
    }
	
    protected static String hibernateConfigFile = null;
	 ...
	 */		
	public static final String TOKEN_KEY  					= "com.realmethods.foundational.common.namespace.TokenKey";
	/**
     ...
     */
    public static final String USER_LOCALE 					= "realMethods_User_Locale";
     ...
     */
    public static final String FRAMEWORK_NAME 				= "realMethodsFramework";
	 ...
	 * Deployment Type
	 */
	public static final String DEPLOY_MODE		= java.lang.System.getProperty("deployMode");
	public static final String SAAS_MODE		= "SaaS";
	 ...
	 * Control Directives
	 */
	public static final boolean SEND_WELCOME_EMAIL	= "true".equalsIgnoreCase(java.lang.System.getProperty("send.welcome.email"));
	
	/**
	 * Common Classpath Root
	 */
	public static final String REALMETHODS_CLASSPATH_ROOT_DIR	= java.lang.System.getProperty("realmethods.classpath.root.dir");
