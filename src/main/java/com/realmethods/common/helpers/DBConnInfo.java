...
public class DBConnInfo {
	...
	public DBConnInfo() {
		...
		final String msg = "driver: " + driver + ", dialet: " + dialect + ", connectionUrl: " + connectionUrl + ", userId: " + userId + ", password: " + password; 
		LOGGER.info( msg );
	...
	public String determineConnectionUrl()
	{
		...
		if ( databaseName != null ) {
			return (connectionUrl.replaceAll(REALMETHODS_TABLE_NAME, databaseName ));
		}
		else
		{
...
// attributes
	...
	private static final String REALMETHODS_TABLE_NAME = System
			.getProperty("realmethods.tablename");
    private static final Logger LOGGER = Logger.getLogger(DBConnInfo.class.getName());
}
