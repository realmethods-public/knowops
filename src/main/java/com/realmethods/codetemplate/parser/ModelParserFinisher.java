...
public class ModelParserFinisher extends AppGenObject
{
	...
	public void finish() throws GenerationException
	{
		try {
			...
			reconcileSuperTypes();
			turnAssociatedClassesIntoAssociations();
			turnAssociationsIntoAttributes();
			generateMethods();
			applyIdentity();
			sortAttributes();
			evaluateMethodArgs();
	...
	/**
	 * Apply identity to the classobject, if required.  Use the primaryKeySuffix to help
	 * locate if one already exists as an attribute.
	 * 
	...
	{
		LOGGER.log(Level.INFO, classObject.getName());
		
		////////////////////////////////////////////////////////////////////////
		// climbs the hierarchy if one looking for identity
		////////////////////////////////////////////////////////////////////////
		if ( !modelParser.hasIdentity(classObject) ) { 	
			////////////////////////////////////////////////////////////////////////
			// if no identity on the classObject or its hierarchy, only proceed
			// if it has no parent, otherwise the parent will have identity applied
			////////////////////////////////////////////////////////////////////////			
			if ( !classObject.hasParent() ) { 			
				AttributeObject attribute 	= null;
				String attributeName 		= classObject.getName().toLowerCase() + "Id";
				String attributeType 		= "Long";
				
				//////////////////////////////////////////////
				// need to create a primary key attribute
				//////////////////////////////////////////////
				attribute = createAnAttributeForClass( classObject, attributeName, attributeType );
	...
	{
		LOGGER.log(Level.INFO, "...where needed throughout model...");
	...
	{
		LOGGER.log(Level.INFO, "...on classes and interfaces... ");
	...
	{
		LOGGER.info("...primary keys first, then all others");
	...
	/**
	 * Forces each ComponentObject in the model to reconcile it's super types
	 */
	private void reconcileSuperTypes()
	{
		...
		LOGGER.info("Verifying lack of Enumerator generalizations and realizations...");
	...
	{
		LOGGER.log(Level.INFO, "...for classes, services, and intefaces...");
	}
	 ...
	 */
	private void turnAssociatedClassesIntoAssociations()
	{
		turnAssociatedClassesIntoAssociations( this.getAllClassesInHierarchy() );
	}
	
	private void turnAssociatedClassesIntoAssociations( List<ClassObject> classes )
	{
		LOGGER.log(Level.INFO, "");
	 ...
	 * 
	 */
	private void turnAssociationsIntoAttributes() {
		LOGGER.log(Level.INFO, "");
	...
	/**
	 * Internal helper class to create an attribute for the provided ClassObject.
	 * 
	 * @param	ClassObject
	 * @return	AttributeObject
	 */
	protected AttributeObject createAnAttributeForClass( ClassObject classObject, String name, String type ) {
		final String msg = "class: " + classObject.getName() + ", attribute: " + type + ":" + name;
		LOGGER.log(Level.INFO, msg);
