...
public class UserDAO extends BaseDAO {
	...
	public User findUser(Long pk) throws FrameworkDAOException {
		...
		StringBuilder fromClause = new StringBuilder("from com.realmethods.entity.User as field where ");
	...
	public User findUserByUserId( String userId ) throws FrameworkDAOException {
		...
		try {
			session = currentSession();
			tx = currentTransaction(session);
			fromClause.append("user.userId = '");
			fromClause.append(userId);
			fromClause.append("'");
			query = session.createQuery(fromClause.toString());
	...
	public User findUserByCredentials( String userId, String password) throws FrameworkDAOException {
		if (userId == null || password == null ) {
			throw new FrameworkDAOException("UserDAO.findUserByCredentials(...) cannot have a null userId or password argument");
		}
	...
	public List<User> findAllUser() throws FrameworkDAOException {
		...
		Query query = null;
		StringBuilder buf = new StringBuilder("from com.realmethods.entity.User");
	...
	// Attributes
	// *****************************************************
	private static final String FROM_CLAUSE	= "from com.realmethods.entity.User as user where ";
