...
public class LocalModelDAO extends BaseDAO {
	...
	public List<LocalModel> findAllLocalModel() throws FrameworkDAOException {
		...
		Query query = null;
		StringBuilder buf = new StringBuilder("from com.realmethods.entity.LocalModel");
	...
	private static final String FROM_QUERY_STRING = "from com.realmethods.entity.LocalModel as field where ";
