...
import com.cloudmigrate.foundational.presentation.struts.*;
 ...
 */
public class BaseStrutsAction extends FrameworkBaseStrutsAction {
	/**
	...
	protected List<String> stages 	= null;
	...
	private static final Logger LOGGER 	= Logger
			.getLogger(BaseStrutsAction.class.getName());
