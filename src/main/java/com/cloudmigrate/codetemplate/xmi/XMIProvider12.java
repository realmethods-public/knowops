...
import com.cloudmigrate.codetemplate.model.factory.ComponentFactory;
import com.cloudmigrate.codetemplate.model.factory.MethodFactory;
import com.cloudmigrate.codetemplate.model.factory.SubsystemFactory;
...
public class XMIProvider12 extends XMIProvider
{
	...
	{
		String methodPath 			= "*/UML:Operation";
	...
	public Map<String, String> getTagNamesAndValues(Node associationNode)
	{
		...
		String keyPath  			= "UML:ModelElement.taggedValue/UML:TaggedValue/UML:TaggedValue.dataValue";
	...
	public String findPackage(Node referenceNode)
	{
		...
		String packagePath 			= "UML:Package";
	...
	{
		String idPath 		= "//*[@xmi.id='" + xmiID + "']/UML:Model";
		String name 		= null;
		try
		{
	...
	{
		String doc = null;
		String documentPath = "UML:ModelElement.taggedValue/UML:TaggedValue/UML:TaggedValue.dataValue";
		try {
	...
	{
		String classPath 	= ".//UML:Class[@xmi.id='" + classID + "']";
		Node classNode 		= null;
	...
	{
		String classPath 	= ".//UML:Interface[@xmi.id='" + interfaceId + "']";
		Node classNode 		= null;
		...
		try {
			...
			final String msg = "Failed to locate an interface node using the class id " + interfaceId;
			LOGGER.log(Level.WARNING, msg, exc);
		}
		return classNode;
	}
	 ...
	 * @return Node
	 */		
	private Node getDataTypeNode(String dataTypeID)
	{
		Node classNode 		= null;
	 ...
	 * @return
	 */
	private int determineUpperRange( Node upperNode, Node associationNode, int lowerRange ) {
	...
	private String getNodeTypeByXMIId(Node node) {
		...
		if (typeRef != null) {
			String typePath = "//UML:DataType[@xmi.id ='" + typeRef + "']";
			try {
	...
	private String getNodeTypeByXMIIDRef(Node node) {
		String type		= null;
	...
	private String findStereotypeByXMIId(String stereoTypeRef) {
		...
		final String stereoTypePath = "//UML:Stereotype[@xmi.id ='" + stereoTypeRef + "']";
	...
	private String findStereotypeByXMIIdRef(Node theNode) { 
		String stereotype 			= "";
	...
	private Node findParameterByClass(Node parameterNode) 
	...
	private Node findParameterByInterface(Node parameterNode)
			throws javax.xml.transform.TransformerException {
	...
	private Node findParameterByDataType(Node parameterNode)
			throws javax.xml.transform.TransformerException {
	...
	private MethodArgs determineMethodArgs( Node classNode, Node parameterNode, String parameterName ) {
		Node kindNode 			= null;
