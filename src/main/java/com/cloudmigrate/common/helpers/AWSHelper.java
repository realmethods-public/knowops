...
public class AWSHelper {
	...
	protected AWSHelper() {
		awsCreds = new com.amazonaws.auth.BasicAWSCredentials(AWS_ACCESSKEY_ID,
	...
	public static final String AWS_ACCESSKEY_ID = System
			.getProperty("aws.accessKeyId");
	public static final String AWS_SECRET_ACCESS_KEY = System
