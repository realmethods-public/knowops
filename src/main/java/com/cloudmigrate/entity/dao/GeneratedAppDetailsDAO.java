...
public class GeneratedAppDetailsDAO extends BaseDAO {
	...
	public List<GeneratedAppDetails> findAllGeneratedAppDetails() throws FrameworkDAOException {
		...
		Query query = null;
		StringBuilder buf = new StringBuilder("from com.cloudmigrate.entity.GeneratedAppDetails");
	...
	// Attributes
	private static final String FROM_QUERY_STRING = "from com.cloudmigrate.entity.GeneratedAppDetails as field where ";
